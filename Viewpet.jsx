    ...
    const PetCard = ({ pet ,index}) => (
        <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} style={{ padding: '16px', textAlign: 'center' }}>
                ...
                <br />
                <br />
                <Button style={{ backgroundColor: 'red', fontWeight: 'bolder' }} variant="contained" onClick={() => handleDelete(pet.user_id)}>Delete Pet</Button>
            <br />
            <br />
            <Link to={`/Editpet/${pet.pet_id}`}><Button
          style={{ backgroundColor: 'orange', fontWeight: 'bolder' }}
          variant="contained"
    ...
    return (
        <div className='images'>
            ...
            <div style={{ marginTop: '20px' }}>
                <Typography style={{ backgroundColor: "skyblue", color: "black", fontWeight: "bolder" }} variant="h5">Available Pets</Typography>
