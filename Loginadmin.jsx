...
export default function Loginadmin() {
  ...
  const handleLogin = (event) => {
    ...
    const storedUsernames = JSON.parse(localStorage.getItem('AdminRegistration')) || [];
  ...
  return (
    <div className='image'>
      ...
      <form onSubmit={handleLogin}>
        ...
        <br />
        <br />
        Don't have your Account<br/><Link style={{color:"red",fontWeight:"bolder"}} to='/Adminregister'>Register</Link>
